...
import { fetchProductDetails, fetchSimilarProducts } from '../../redux/slices/productSlice'; // Make sure to import these
...
const ProductDetails = ({ productId }) => {
    ...
    const [isButtonDisabled, setIsButtonDiasabled] = useState(false);
    ...
    const handleAddToCart = () => {
        ...
        dispatch(
            ...
            .finally(() => setIsButtonDiasabled(false))
    };
    if (loading) {
        return <p>Loading ...</p>
    }
