...
const Checkout = () => {
    ...
    //enshure cart is loaded befor procceding
    useEffect(()=>{
        ...
        <div className="bg-white rounded-lg p-6">
            ...
            <form onSubmit={handleCreateCheckout} >
                ...
                <div className="mb-4">
                    ...
                    <input type="text" value={shippingAddress.address} onChange={(e) => 
                ...
                <div className="mb-4">
                    ...
                    <input type="text" value={shippingAddress.country} onChange={(e) => 
                        setShippingAddress({...shippingAddress,country: e.target.value,})} 
                        className="w-full p-2 border rounded" required/>
                </div>
                <div className="mb-4">
                    <label className="block text-gray-700" >Phone</label>
                    <input type="tel" value={shippingAddress.phone} onChange={(e) => 
